...
const PAGES = require("C:/Users/drhab/OneDrive/Desktop/new-minasaati/.pi/artifacts/frontend-migration/pages.json");
const HEALTH_PATHS = require("C:/Users/drhab/OneDrive/Desktop/new-minasaati/.pi/artifacts/frontend-migration/health-paths.json");
...
(async function () {
  ...
  let adminToken = null;
  try {
    if (fs.existsSync("C:/Users/drhab/OneDrive/Desktop/new-minasaati/.pi/tokens.json")) {
      const tokens = JSON.parse(fs.readFileSync("C:/Users/drhab/OneDrive/Desktop/new-minasaati/.pi/tokens.json", "utf8"));
  ...
  await browser.close();
  fs.writeFileSync("C:/Users/drhab/OneDrive/Desktop/new-minasaati/.pi/artifacts/frontend-migration/capture-results.json", JSON.stringify(results, null, 2));
